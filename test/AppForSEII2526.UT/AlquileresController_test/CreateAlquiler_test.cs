...
namespace AppForSEII2526.UT.AlquileresController_test
{
    public class CreateAlquiler_test : AppForSEII25264SqliteUT
    {
        ...
        public CreateAlquiler_test()
        {
            ...
            {
                new Herramienta (DateOnly.FromDateTime(DateTime.Today.AddDays(-1)), _nombreHerramienta1, "Acero" , 10.0f, 5 ,fabricante[0]),
                new Herramienta (DateOnly.FromDateTime(DateTime.Today.AddDays(-2)), _nombreHerramienta2, "Madera" ,15.7f, 8 , fabricante[1])
            };
