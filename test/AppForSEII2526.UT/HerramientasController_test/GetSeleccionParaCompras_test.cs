...
namespace AppForSEII2526.UT.HerramientasController_test
{
    public class GetSeleccionParaCompra_test : AppForSEII25264SqliteUT
    {
        ...
        public static IEnumerable<object[]> TestCasesFor_GetHerramientasParaComprar_Ok()
        {
            ...
            {
                new HerramientasParaComprarDTO(DateOnly.FromDateTime(DateTime.Today.AddDays(-1)), "Nombre - Herramienta1", "Material - Herramientas1y2", "Nombre - Fabricante1", 10.99f, 1),
                new HerramientasParaComprarDTO(DateOnly.FromDateTime(DateTime.Today.AddDays(-2)), "Nombre - Herramienta2", "Material - Herramientas1y2", "Nombre - Fabricante2", 2.99f, 2),
                new HerramientasParaComprarDTO(DateOnly.FromDateTime(DateTime.Today.AddDays(-3)), "Nombre - Herramienta3", "Material - Herramienta3", "Nombre - Fabricante2", 3.99f, 3)
            };
