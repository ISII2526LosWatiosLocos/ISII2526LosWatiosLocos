...
namespace AppForSEII2526.UT.HerramientasController_test
{
    public class GetSeleccionParaReparacion_test : AppForSEII25264SqliteUT
    {
        public GetSeleccionParaReparacion_test()
        {
            ...
            {
                new Herramienta("Martillo", "Acero", 15.5f, 5, fabricante[0]),   // 5 días reparación
                new Herramienta("Destornillador", "Acero", 7.0f, 3, fabricante[1]), // 3 días reparación
                new Herramienta("Taladro", "Plástico", 5.0f, 10, fabricante[2]) // 10 días reparación
            };
