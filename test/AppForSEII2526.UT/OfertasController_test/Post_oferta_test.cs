...
namespace AppForSEII2526.UT.OfertasController_test
{
    public class Post_oferta_test : AppForSEII25264SqliteUT
    {
        ...
        public Post_oferta_test()
        {
            ...
            {
                new Herramienta (DateOnly.FromDateTime(DateTime.Today.AddDays(-1)), _nombreHerramienta1, "Acero" , 10.0f, 99, 5 ,fabricante[0]),
                new Herramienta (DateOnly.FromDateTime(DateTime.Today.AddDays(-1)), _nombreHerramienta2, "Madera" ,15.7f, 99, 8 ,fabricante[1])
            };
