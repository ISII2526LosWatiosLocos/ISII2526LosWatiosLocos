...
namespace AppForSEII2526.UT.ReparacionesController_test
{
    public class PostParaReparacion_test : AppForSEII25264SqliteUT
    {
        public PostParaReparacion_test()
        {
            ...
            {
                new Herramienta(DateOnly.FromDateTime(DateTime.Today.AddDays(-1)), "Taladro", "Acero", 50.0f, 10, new List<CompraItem>(), new List<AlquilarItem>(), new List<OfertaItem>(), new List<ReparaciónItem>(), fabricante1),
                new Herramienta(DateOnly.FromDateTime(DateTime.Today.AddDays(-1)), "Martillo", "Hierro", 20.0f, 15, new List<CompraItem>(), new List<AlquilarItem>(), new List<OfertaItem>(), new List<ReparaciónItem>(), fabricante2),
                new Herramienta(DateOnly.FromDateTime(DateTime.Today.AddDays(-1)), "Sierra", "Acero", 30.0f, 8, new List<CompraItem>(), new List<AlquilarItem>(), new List<OfertaItem>(), new List<ReparaciónItem>(), fabricante2)
            };
